...
KEYCODES_SMARTCHORD_BUTTONS = [
    K("SMARTCHORD_DOWN", "QuickShord\nDown", "QuickChordDown"),
    K("SMARTCHORD_UP", "QuickChord\nUp", "QuickChordUp"),
    K("MI_CHORD_99", "QuickChord", "QuickChord"),
]
...
def recreate_keycodes():
    ...
    KEYCODES.extend(KEYCODES_SPECIAL + KEYCODES_BASIC + KEYCODES_SHIFTED + KEYCODES_ISO + KEYCODES_LAYERS + KEYCODES_LAYERS_DF + KEYCODES_LAYERS_MO + KEYCODES_LAYERS_TG + KEYCODES_LAYERS_TT + KEYCODES_LAYERS_OSL + KEYCODES_LAYERS_TO + KEYCODES_LAYERS_LT +
                    KEYCODES_BOOT + KEYCODES_MODIFIERS + KEYCODES_QUANTUM + KEYCODES_BACKLIGHT + KEYCODES_MEDIA + KEYCODES_OLED + KEYCODES_CLEAR + KEYCODES_RGB_KC_COLOR + KEYCODES_SMARTCHORD_BUTTONS +
