...
class FilteredTabbedKeycodes(QTabWidget):
    ...
    def __init__(self, parent=None, keycode_filter=keycode_filter_any):
        ...
        self.tabs = [
            ...
            LayerTab(self, "Layer", KEYCODES_LAYERS, KEYCODES_LAYERS_DF, KEYCODES_LAYERS_MO, KEYCODES_LAYERS_TG, KEYCODES_LAYERS_TT, KEYCODES_LAYERS_OSL, KEYCODES_LAYERS_TO),
